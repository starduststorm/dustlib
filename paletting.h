...
// Flag colors are pulled from publically available values, then refined to render better on my SMD LEDs
...
DEFINE_GRADIENT_PALETTE( Trans_Flag_Smooth_gp ) {
  0,   0x5B, 0xCE, 0xFA,
  40,  0x5B, 0xCE, 0xFA,
  61,  0xF5, 0x90, 0xA0,
  91,  0xF5, 0x90, 0xA0,
...
// double-purple version for projects which do not have enough pixels to show contrast
DEFINE_GRADIENT_PALETTE( Ace_Flag_DoublePurple_gp ) {
  0,   0x40, 0x40, 0x40,
  63,  0x40, 0x40, 0x40,
  64,  0x71, 0x00, 0x81,
  127, 0x71, 0x00, 0x81,
...
// use very dim light instead of off to draw the black band
...
// three-band version for projects which do not have enough pixels to show contrast
DEFINE_GRADIENT_PALETTE( Enby_Flag_ThreeBand_gp ) {
  0,   0xFF, 0xF4, 0x30,
  85,  0xFF, 0xF4, 0x30,
  86,  0xFF, 0xFF, 0xFF,
  170, 0xFF, 0xFF, 0xFF,
...
// 2-band variant
DEFINE_GRADIENT_PALETTE( Intersex_Flag_TwoBand_gp ) {
  0,   0x6E, 0x07, 0xD7,
  127,  0x6E, 0x07, 0xD7,
  128, 0xFF, 0xFF, 0x00,
  255, 0xFF, 0xFF, 0x00,
